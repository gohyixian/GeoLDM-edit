...
python check_gpu.py
python main_geom_drugs.py --config_file custom_config/CrossDocked/20240623__10A/full/AMP/PKT_Only/latest/DICC/AMP__01_VAE_vaenorm_True10__float32__latent8_nf128_epoch100_bs2_lr1e-5_InvClassFreq_Smooth0.25_x30_h15_NoEMA__20240623__10A__PKT_Only.yaml