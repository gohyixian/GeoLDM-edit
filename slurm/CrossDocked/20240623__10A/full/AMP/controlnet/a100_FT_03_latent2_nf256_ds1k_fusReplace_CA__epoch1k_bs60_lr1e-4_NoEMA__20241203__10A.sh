...
#SBATCH --mem=100G
#SBATCH --gpus=1
#SBATCH --job-name=FT_03_latent2_nf256_ds1k_fusReplace_CA__epoch1k_bs60_lr1e-4_NoEMA__20241203__10A
#SBATCH --output=slurm_out/FT_03_latent2_nf256_ds1k_fusReplace_CA__epoch1k_bs60_lr1e-4_NoEMA__20241203__10A.out
#SBATCH --error=slurm_err/FT_03_latent2_nf256_ds1k_fusReplace_CA__epoch1k_bs60_lr1e-4_NoEMA__20241203__10A.err
#SBATCH --qos=long
