...
#SBATCH --mem=100G
#SBATCH --gpus=2
#SBATCH --job-name=train_base_geom_all_config_AMP__+_vae_ldm_trained_20240602
#SBATCH --output=slurm_out/train_base_geom_all_config_AMP__+_vae_ldm_trained_20240602.out
#SBATCH --error=slurm_err/train_base_geom_all_config_AMP__+_vae_ldm_trained_20240602.err
#SBATCH --qos=long
